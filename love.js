(function (window) {
    ...
    // UPDATED: Changed from heart formula to circular distribution
    ...
    // UPDATED: Draws a 5-petal flower instead of a heart
    Heart = function () {
        var points = [], x, y, t;
        for (var i = 0; i < 2 * Math.PI; i += 0.1) {
            var r = 10 + 5 * Math.sin(5 * i);
            x = r * Math.cos(i);
            y = r * Math.sin(i);
    ...
    Seed.prototype = {
        ...
        drawText: function () {
            ...
            ctx.fillText("Hold your device vertically", 30, -20);
    ...
    Bloom = function (tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        // UPDATED: Palette of flower colors
        var flowerColors = ['#FF69B4', '#FFD700', '#FFA500', '#FF1493'];
        this.color = color || flowerColors[random(0, flowerColors.length - 1)];
